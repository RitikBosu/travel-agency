...
export const action = async ({ request }: ActionFunctionArgs) => {
    ...
    try {
        ...
        return data({ error: 'Server configuration error. Please check environment variables.' }, { status: 500 });
    }
    ...
    try {
        ...
        return data({ error: 'Failed to generate trip. Please try again.' }, { status: 500 });
    }
}
